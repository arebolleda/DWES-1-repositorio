...
echo "La mascara es: $mask <br>";
echo"<br>";

/*Selecciono los 16 primeros digitos de la ip, y los relleno con 0*/

echo "La direccion de red es: <br>";

$stri1=substr($ip1,0,$mask);
$dred=str_pad($stri1,32,"0");
...
echo "La direccion de broadcast es: <br>";
$stri1=substr($ip1,0,$mask);
$broad=str_pad($stri1,32,"1");
...
/*Sumamos 1 a la direccion de red y restamos 1 a la direccion de broadcast*/

echo "El rango de IPs va desde: <br>";
